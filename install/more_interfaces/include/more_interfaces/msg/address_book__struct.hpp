...
#ifndef MORE_INTERFACES__MSG__ADDRESS_BOOK__STRUCT_HPP_
#define MORE_INTERFACES__MSG__ADDRESS_BOOK__STRUCT_HPP_
...
struct AddressBook_
{
  ...
  explicit AddressBook_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit AddressBook_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : first_name(_alloc),
    last_name(_alloc),
    address(_alloc)
  {
...
#endif  // MORE_INTERFACES__MSG__ADDRESS_BOOK__STRUCT_HPP_
