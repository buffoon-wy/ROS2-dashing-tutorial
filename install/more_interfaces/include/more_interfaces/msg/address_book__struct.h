...
#ifndef MORE_INTERFACES__MSG__ADDRESS_BOOK__STRUCT_H_
#define MORE_INTERFACES__MSG__ADDRESS_BOOK__STRUCT_H_
...
#endif  // MORE_INTERFACES__MSG__ADDRESS_BOOK__STRUCT_H_
