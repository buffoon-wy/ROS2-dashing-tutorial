...
#ifndef MYMSGS__MSG__PACKET_MSG__STRUCT_H_
#define MYMSGS__MSG__PACKET_MSG__STRUCT_H_
...
{
  rosidl_generator_c__uint8__Sequence buf;
...
#endif  // MYMSGS__MSG__PACKET_MSG__STRUCT_H_
