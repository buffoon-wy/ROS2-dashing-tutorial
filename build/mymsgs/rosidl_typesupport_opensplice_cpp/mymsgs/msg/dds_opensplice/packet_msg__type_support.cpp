...
#include "mymsgs/msg/packet_msg__rosidl_typesupport_opensplice_cpp.hpp"
...
using __dds_msg_type_PacketMsg = mymsgs::msg::dds_::PacketMsg_;
using __ros_msg_type_PacketMsg = mymsgs::msg::PacketMsg;

static mymsgs::msg::dds_::PacketMsg_TypeSupport __type_support_PacketMsg;

ROSIDL_TYPESUPPORT_OPENSPLICE_CPP_EXPORT_mymsgs
const char *
register_type__PacketMsg(
  ...
  const char * type_name)
{
  ...
  DDS::ReturnCode_t status = __type_support_PacketMsg.register_type(participant, type_name);
  switch (status) {
...
convert_ros_message_to_dds(
  const __ros_msg_type_PacketMsg & ros_message,
  __dds_msg_type_PacketMsg & dds_message)
{
  // member.name buf
  {
    ...
    for (DDS::ULong i = 0; i < size; i++) {
      dds_message.buf_[i] = ros_message.buf[i];
    }
  }
}
  ...
  const void * untyped_ros_message)
{
  ...
  const __ros_msg_type_PacketMsg & ros_message = *static_cast<const __ros_msg_type_PacketMsg *>(untyped_ros_message);
  __dds_msg_type_PacketMsg dds_message;
...
convert_dds_message_to_ros(
  const __dds_msg_type_PacketMsg & dds_message,
  __ros_msg_type_PacketMsg & ros_message)
{
  // member.name buf
  {
    ...
    for (DDS::ULong i = 0; i < size; i++) {
      ros_message.buf[i] = dds_message.buf_[i];
    }
  }
}
  ...
  void * sending_publication_handle)
{
  ...
  if (!ignore_sample) {
    __ros_msg_type_PacketMsg & ros_message = *static_cast<__ros_msg_type_PacketMsg *>(untyped_ros_message);
  ...
  void * untyped_serialized_data)
{
  ...
  DDS::OpenSplice::CdrTypeSupport cdr_ts(__type_support_PacketMsg);
...
static message_type_support_callbacks_t PacketMsg_callbacks = {
  "mymsgs::msg",
  "PacketMsg",
  &register_type__PacketMsg,
  &publish__PacketMsg,
...
static rosidl_message_type_support_t PacketMsg_handle = {
...
{
  return &mymsgs::msg::typesupport_opensplice_cpp::PacketMsg_handle;
}
