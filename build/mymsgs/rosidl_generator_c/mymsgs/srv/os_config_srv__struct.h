...
#ifndef MYMSGS__SRV__OS_CONFIG_SRV__STRUCT_H_
#define MYMSGS__SRV__OS_CONFIG_SRV__STRUCT_H_
...
{
  rosidl_generator_c__String metadata;
...
#endif  // MYMSGS__SRV__OS_CONFIG_SRV__STRUCT_H_
