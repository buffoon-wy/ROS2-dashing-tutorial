...
#include <stddef.h>
#include "mymsgs/srv/os_config_srv__rosidl_typesupport_introspection_c.h"
#include "mymsgs/msg/rosidl_typesupport_introspection_c__visibility_control.h"
#include "rosidl_typesupport_introspection_c/field_types.h"
#include "rosidl_typesupport_introspection_c/identifier.h"
#include "rosidl_typesupport_introspection_c/message_introspection.h"
#include "mymsgs/srv/os_config_srv__struct.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers mymsgs__srv__os_config_srv__rosidl_typesupport_introspection_c__OSConfigSrv_service_members = {
  "mymsgs__srv",  // service namespace
  "OSConfigSrv",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // mymsgs__srv__os_config_srv__rosidl_typesupport_introspection_c__OSConfigSrv_Request_message_type_support_handle,
  NULL  // response message
  // mymsgs__srv__os_config_srv__rosidl_typesupport_introspection_c__OSConfigSrv_Response_message_type_support_handle
};

static rosidl_service_type_support_t mymsgs__srv__os_config_srv__rosidl_typesupport_introspection_c__OSConfigSrv_service_type_support_handle = {
  0,
  &mymsgs__srv__os_config_srv__rosidl_typesupport_introspection_c__OSConfigSrv_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mymsgs, srv, OSConfigSrv)() {
  if (!mymsgs__srv__os_config_srv__rosidl_typesupport_introspection_c__OSConfigSrv_service_type_support_handle.typesupport_identifier) {
    mymsgs__srv__os_config_srv__rosidl_typesupport_introspection_c__OSConfigSrv_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)mymsgs__srv__os_config_srv__rosidl_typesupport_introspection_c__OSConfigSrv_service_type_support_handle.data;
  ...
  return &mymsgs__srv__os_config_srv__rosidl_typesupport_introspection_c__OSConfigSrv_service_type_support_handle;
}
