...
static const _OSConfigSrv_Request_type_support_symbol_names_t _OSConfigSrv_Request_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, mymsgs, srv, OSConfigSrv_Request)),
  }
};
...
static const _OSConfigSrv_Response_type_support_symbol_names_t _OSConfigSrv_Response_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, mymsgs, srv, OSConfigSrv_Response)),
  }
};
...
static const _OSConfigSrv_type_support_symbol_names_t _OSConfigSrv_service_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_opensplice_c, mymsgs, srv, OSConfigSrv)),
  }
};
